...
- `haskell.packages` builds Cabal packages and publishes generated Haddock API pages. Use `modulePrefixes` to limit published modules for packages with multiple public libraries.
