        ...
        checks = {
          ...
          docs-html = mkAssertionCheck {
            ...
            script = ''
              ...
              grep -q "repo-docs-haddock-breadcrumb" "$site/Haskell/demo/haddock/Demo-Sample.html"
          ...
          in
            mkAssertionCheck {
              ...
              script = ''
                ...
                test -f "$site/Haskell/demo/index.html"
                test -f "$site/Haskell/demo/Demo/Sample/index.html"
                grep -q 'docs-haskell-package-card' "$site/Haskell/index.html"
                grep -q 'docs-haskell-package-card-title">Haddock Demo API' "$site/Haskell/index.html"
                grep -q 'docs-haskell-package-card-desc">Generated Haddock API fixture' "$site/Haskell/index.html"
                test -f "$site/Haskell/demo/haddock/Demo-Sample.html"
                test -f "$site/Haskell/demo/haddock/src/Demo.Sample.html"
                test -f "$site/Haskell/demo/haddock/repo-docs-haddock.css"
                ...
                grep -q 'repo-docs-haddock-breadcrumb' "$site/Haskell/demo/haddock/index.html"
                grep -q 'syncParentRouteFromHaddock' "$site/Haskell/demo/index.html"
                grep -q 'data-docs-nav-link' "$site/Haskell/demo/Demo/Sample/index.html"
                grep -q '../repo-docs-haddock.css' "$site/Haskell/demo/haddock/src/Demo.Sample.html"
                grep -q 'repo-docs-source-line-number' "$site/Haskell/demo/haddock/src/Demo.Sample.html"
